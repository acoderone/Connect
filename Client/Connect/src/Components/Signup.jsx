  ...
  return (
    <>
      <div className="flex justify-center  items-center">
        <div className="flex w-1/2 bg-blue-200  justify-center items-center flex-col">
        ...
        <div className="flex flex-col items-center gap-10 justify-center  w-1/2 py-10  bg-blue-100">
